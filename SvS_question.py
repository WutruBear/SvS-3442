...
:root{
 --bg:#070b14;
 --bg-gradient:radial-gradient(circle at top right,#1d2450 0%,#070b14 45%);
 --surface:rgba(18,24,38,.72);
 --surface-2:rgba(25,33,52,.85);
...
.topnav,.stat-card,.guide-card,.stepper,
...
.stat-card:hover,.guide-card:hover{
